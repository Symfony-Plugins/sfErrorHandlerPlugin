...
class sfHardenedRenderingFilter extends sfFilter
{
  ...
  public function execute($filterChain)
  {
    if ($this->isFirstCall())
    {
      ...
      // if we're in a prod environment we want E_ALL, but not to fail on E_NOTICE or E_STRICT
    ...
    try {
      ...
      ob_end_clean(); // don't care what's in the buffer, we've got all we need
